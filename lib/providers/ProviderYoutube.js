...
module.exports = class extends Provider{
    ...
    info(id){
        ...
        return new Promise((resolve, reject) => {
            ...
            this.request(`${YT_API_BASE}videos?key=${this.config.key}&part=snippet%2CcontentDetails%2Cstatus&id=${id}`, (err, res) => {
                if(err){
                ...
                const duration = ytTimeToSecs(video.contentDetails.duration);
