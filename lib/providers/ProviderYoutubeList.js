...
const EntityYoutube = require('../entities/EntityYoutube');
const EntityYoutubeList = require('../entities/EntityYoutubeList');
...
module.exports = class extends Provider{
    ...
    info(id){
        ...
        return new Promise((resolve, reject) => {
            ...
            request(`${YT_API_BASE}playlists?key=${this.config.key}&part=ContentDetails%2Csnippet&id=${id}`, (err, res) => {
                if(err){
